...
import intec from './files/The Intersection of Generative Language Modeling.pdf'
const docs = [
{
    'title':'Probabilistic Methods for State Estimation',
    'desc':'Integrating Markov Chains and Naïve Bayesian Classification for Rapid Weapon Pairing in Naval Warfare',
